    ...
    <section class="row h-100 ">
      <aside class="col-xs-12 col-md-5 left">
        <svg width="100%" height="100%" viewBox="0 0 100% 100%" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
          ...
          <g id="module-01" transform="translate(-1.000000, 0.000000)" class="path path-01" stroke="url(#linear)" stroke-width="4"  fill-rule="evenodd" stroke-linecap="butt" stroke-linejoin="round" fill="none" stroke-opacity="1" stroke-dasharray="8,960,24,960,16,400" stroke-dashoffset="6400">
          ...
          <g id="module-03" transform="translate(1024.000000, 164.000000)" class="path path-03" stroke="url(#linear)" stroke-width="4"  fill-rule="evenodd" stroke-linecap="butt" stroke-linejoin="round" fill="none" stroke-opacity="1" stroke-dasharray="8,960,24,960,16,400" stroke-dashoffset="6400">
          ...
          <g id="module-04" transform="translate(1532.000000, 115.000000)" class="path path-04" stroke="url(#linear)" stroke-width="4"  fill-rule="evenodd" stroke-linecap="butt" stroke-linejoin="round" fill="none" stroke-opacity="1" stroke-dasharray="8,960,24,960,16,400" stroke-dashoffset="6400">
            <g id="C19">
          ...
          <g id="module-05" transform="translate(1908.000000, 0.000000)" class="path path-05" stroke="url(#linear)" stroke-width="4"  fill-rule="evenodd" stroke-linecap="butt" stroke-linejoin="round" fill="none" stroke-opacity="1" stroke-dasharray="8,960,24,960,16,400" stroke-dashoffset="6400">
            <g id="C13">
              <polyline points="272 196 288 196 300 208 300 224 324 248 416 248 421 243 428 243"></polyline>
              <polyline points="272 188 292 188 308 204 308 220 328 240 412.005952 240 420.002977 232.002976 480 232.002976 493.001488 219.001488 494 218 494 171"></polyline>
              <path d="M272,180 L284,180"></path>
      ...
      <div class="col-xs-12 col-md-7 right">
        <div class="row h-100 no-gutter flex-column">
          <nav class="navbar navbar-expand-lg navbar-light align-items-start">
            <a class="navbar-brand" href="http://www.sam-robotics.ro"><img src="~@/assets/sam_logo.jpg" height="96  "/></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav ml-auto align-items-end">
                <li class="nav-item active mt-4">
                  <router-link to="services" class="text-right font-weight-bold">Servicii si produse</router-link>
                </li>
                <li class="nav-item mt-4 pt-4">
                  <router-link to="about" class="text-center  font-weight-bold">
                    Despre noi
                  </router-link>
                </li>
                <li class="nav-item dropdown  mt-4 pt-4">
                  <router-link to="news"  class="text-center font-weight-bold">Noutati si Info</router-link>
                </li>
                <li class="nav-item  mt-4 pt-4">
                  <router-link to="contact" class="text-center font-weight-bold">Contact</router-link>
                </li>
              </ul>
            </div>
          </nav>
